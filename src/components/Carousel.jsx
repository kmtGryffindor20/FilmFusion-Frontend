    ...
    <Carousel className="rounded-xl h-[40rem] mt-16 mb-16 font-sans">
      <div className="relative h-full w-full px-24">
        ...
        <div className="absolute inset-0 grid h-full w-full place-items-center bg-primary/50">
          <div className="w-3/4 text-center md:w-2/4">
            ...
            >
              S.S Rajamouli’s R.R.R wins Oscar at the biggest stage.
            </Typography>
      ...
      <div className="relative h-full w-full px-24">
        <img
          ...
          className="h-full w-full object-cover"
        />
        <div className="absolute inset-0 grid h-full w-full items-center bg-primary/50">
      ...
      <div className="relative h-full w-full px-24">
        <img
          ...
          className="h-full w-full object-cover"
        />
        <div className="absolute inset-0 grid h-full w-full items-end bg-primary/50">
